export const EVENT_CONFIG = {
  ...
  manifesto: 'O Connect Valley e uma manifestacao do espirito empreendedor, inspirado na ideia de que sao os grandes pensadores, inovadores e lideres que sustentam o mundo.',
  dates: {
  ...
  social: {
    instagram: 'https://instagram.com/connectvalley',
